...
///
/// Not implemented yet! Currently, it does not contain any useful functionality,
/// it only blindly forwards the messages and returns errors once a non-implemented
/// part is triggered.
pub async fn run_widget_api(
    ...
    // Equivalent of `from.map(|m| Ok(Event::MesssageFromWidget(msg)).forward(events_tx)`,
